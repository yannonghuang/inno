...
#source c:/Adexa/adm/SCP_CUSTOM/semicon/SCP/SCRIPTS/import_main_CONS.tcl
##############################################################################
##
...
# vn	
#	set path(main) "c:/Adexa/adm/SCP_CUSTOM/semicon/SCP";	
	...
	#Supply for AMD demo
	source $path(script)/supply_mdm.tcl
	#Demand for AMD demo
