...
SELECT [PRODUCT_ID]
      ...
      ,[HIER_LEVEL_1] --,STRING_AGG(HIER_LEVEL_1, '_') WITHIN GROUP (ORDER BY HIER_LEVEL_1 ASC) --
      ,[HIER_LEVEL_2] --,STRING_AGG(HIER_LEVEL_2, '_') WITHIN GROUP (ORDER BY HIER_LEVEL_2 ASC) 
      ,STRING_AGG(HIER_LEVEL_3, '_') WITHIN GROUP (ORDER BY HIER_LEVEL_3 ASC) --,[HIER_LEVEL_3] --
