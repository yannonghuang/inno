...
*/
    ...
    where Method_Buy.PRODUCT_ID = adx_product.PRODUCT_ID and (
      ...
      exists (select * from NATIVE_RAW_SUBSTITUTES where Method_Buy.PRODUCT_ID = NATIVE_RAW_SUBSTITUTES.component and NATIVE_RAW_SUBSTITUTES.Assemble_P_N = process.P_N)
    ) 
